...
watch(newSize, (newVal) => {
  // TODO: validate on @change instead
  if (newVal.width < config.public.minCanvasSize) newSize.width = config.public.minCanvasSize;
  if (newVal.height < config.public.minCanvasSize) newSize.height = config.public.maxCanvasSize;
  if (newVal.width > config.public.maxCanvasSize) newSize.width = config.public.maxCanvasSize;
  if (newVal.height > config.public.maxCanvasSize) newSize.height = config.public.maxCanvasSize;
});
